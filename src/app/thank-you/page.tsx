          ...
          <div className="lg:col-start-2 ">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Your order hwas processed successfully. You will receive an
                email confirmation shortly and your assets are available to
                download below. We&apos;ve also sent your receipt amd order
                details to{" "}
