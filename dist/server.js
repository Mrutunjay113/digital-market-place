...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                payload = _a.sent();
                app.post("/api/webhook/stripe", webhookMiddleware, webhooks_1.stripewebookHandler);
                cartRouter = express_1.default.Router();
                cartRouter.use(payload.authenticate);
                cartRouter.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                    var request, parserdUrl;
                    return __generator(this, function (_a) {
                        request = req;
                        if (!request.user) {
                            return [2 /*return*/, res.redirect("/sign-in?origin=cart")];
                        }
                        parserdUrl = (0, url_1.parse)(req.url, true);
                        return [2 /*return*/, next_utils_1.nextApp.render(req, res, "/cart", parserdUrl.query)];
                    });
                }); });
                ...
                if (process.env.NEXT_BUILD) {
                    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    payload.logger.info("NExt.js is building for production on port ".concat(PORT));
                                    //@ts-expect-error
                ...
                next_utils_1.nextApp.prepare().then(function () {
                    payload.logger.info("Next.js started on port ".concat(PORT));
                    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
