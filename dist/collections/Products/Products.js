    ...
    hooks: {
        ...
        beforeChange: [
            ...
            function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var data, createProuct, updated, data, updatedProuct, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            createProuct = _a.sent();
                            updated = __assign(__assign({}, data), { stripId: createProuct.id, priceId: createProuct.default_price });
                            return [2 /*return*/, updated];
                        case 2:
                            if (!(args.operation === "update")) return [3 /*break*/, 4];
                            data = args.data;
                            return [4 /*yield*/, stripe_1.stripe.products.update(data.stripId, {
                                    name: data.name,
                                    default_price: data.priceId,
                                })];
                        case 3:
                            updatedProuct = _a.sent();
                            updated = __assign(__assign({}, data), { stripId: updatedProuct.id, priceId: updatedProuct.default_price });
                            return [2 /*return*/, updated];
